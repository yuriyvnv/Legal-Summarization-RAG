...
def evaluate_dataset(eval_file_path: str, k_values: List[int], batch_size: int = 10000, num_workers: int = 3) -> Dict:
    ...
    client = PersistentClient(path="/home/yperezhohin/Legal-Summarization-RAG/data/benchmarks/fine_tuned_Embedding_multiqa_ours")
...
def main():
    ...
    output_folder = "evaluation_results_ours_finetuned_multiK"
