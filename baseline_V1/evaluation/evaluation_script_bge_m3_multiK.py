...
def evaluate_dataset(eval_file_path: str, k_values: List[int], batch_size: int = 10000, num_workers: int = 24) -> Dict:
    ...
    client = PersistentClient(path="/home/yperezhohin/Legal-Summarization-RAG/data/benchmarks/baseline_ours_bge_m3")
...
def main():
    ...
    output_folder = "evaluation_results_bge_m3_multiK"
