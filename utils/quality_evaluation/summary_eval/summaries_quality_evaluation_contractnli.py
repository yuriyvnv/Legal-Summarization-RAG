...
"""
    ...
    def batch_evaluate_summaries(self, prompts: List[str], batch_size: int = 6, max_new_tokens: int = 128) -> List[str]:
        """
    ...
    def process_document(self, doc_name: str, chunks: List[Dict], batch_size: int = 6) -> Dict:
        """
...
def evaluate_documents(json_file_path: str, batch_size: int = 6) -> Dict:
    """
    ...
    output_path = "results_evaluation_contractnli.json"
...
def main():
    ...
    try:
        json_file_path = "/home/yperezhohin/Legal-Summarization-RAG/summarized_docs_contractnli.json"
        results = evaluate_documents(json_file_path, batch_size=6)
