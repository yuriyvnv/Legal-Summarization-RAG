...
os.environ["CUDA_VISIBLE_DEVICES"] = "1"  # Use first GPU
...
def precompute_batch_embeddings(texts, model_path="sentence-transformers/gtr-t5-xxl"):
...
class PrecomputedEmbeddingFunction:
    def __init__(self, model_path="sentence-transformers/gtr-t5-xxl"):
...
class HierarchicalRAGStore:
    def __init__(self, persist_directory):
        ...
        self.embedding_function = PrecomputedEmbeddingFunction(model_path="sentence-transformers/gtr-t5-xxl")
        ...
        for attempt in range(max_retries):
            try:
                ...
                logger.info("📄 Created documents collection with GTR-T5-XXL embeddings.")
                ...
                logger.info("🔍 Created chunks collection with GTR-T5-XXL embeddings.")
...
def main():
    ...
    persist_directory = os.path.expanduser("~/rag_project/data/benchmarks/baseline_ours_gtr5_xxl")
    ...
    file_path = os.path.expanduser("~/rag_project/data/combined_summarized_corrected/final_summaries_striped.json")
