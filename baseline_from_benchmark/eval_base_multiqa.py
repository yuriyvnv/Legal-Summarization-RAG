...
def evaluate_dataset(eval_file_path: str, k_values: List[int], batch_size: int = 20, num_workers: int = 8) -> Dict:
    ...
    client = PersistentClient(path="/home/yperezhohin/Legal-Summarization-RAG/data/benchmarks/baseline_benchmark_original_multiqa")
...
def main():
    ...
    output_folder = "evaluation_results_benchmark_multiqa_multi_k"
